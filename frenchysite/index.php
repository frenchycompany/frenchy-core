 ...
 * Location premium · Minimaliste · Élégant
 *
...
$hero_img = vf_photo_url($db_photos, 'hero', 'hero',
...
<head>
    ...
    <meta name="description" content="<?= htmlspecialchars($site['name']) ?> à <?= htmlspecialchars($site['address']) ?> — Séjour de charme. Confort, élégance et détente.">

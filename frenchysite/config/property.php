...
return [
    ...
    // ══════════ Guides (seed initial — migration vers BDD) ══════════
    // Ces guides servent UNIQUEMENT au premier lancement pour peupler
    // la table vf_guides. Ensuite ils se gèrent via l'onglet Guides de l'admin.
    'guides' => [
        'wifi' => [
            'label'       => 'WiFi',
            'admin_label' => 'WiFi',

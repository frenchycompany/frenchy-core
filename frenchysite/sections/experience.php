...
<section id="experience" class="vf-section vf-section--white">
    <div class="vf-container">
        <h2 class="vf-heading vf-heading--center"><?= htmlspecialchars(vf_text($txt, 'experience', 'title', 'L\'expérience')) ?></h2>
        ...
        <div class="vf-cards">
            ...
            <article class="vf-card">
                ...
                <div class="vf-card-body">
                    ...
                    <h3 class="vf-card-title"><?= htmlspecialchars(vf_text($txt, 'experience', 'card1_title', 'Confort')) ?></h3>
                    <p class="vf-card-text"><?= htmlspecialchars(vf_text($txt, 'experience', 'card1_text', 'Des espaces généreux, une literie de qualité et tout le nécessaire pour un séjour sans compromis.')) ?></p>
                </div>
            </article>
            ...
            <article class="vf-card">
                ...
                <div class="vf-card-body">
                    ...
                    <h3 class="vf-card-title"><?= htmlspecialchars(vf_text($txt, 'experience', 'card2_title', 'Charme')) ?></h3>
                    <p class="vf-card-text"><?= htmlspecialchars(vf_text($txt, 'experience', 'card2_text', 'Une décoration soignée, une ambiance chaleureuse et des détails qui font toute la différence.')) ?></p>
                </div>
            </article>
            ...
            <article class="vf-card">
                ...
                <div class="vf-card-body">
                    ...
                    <h3 class="vf-card-title"><?= htmlspecialchars(vf_text($txt, 'experience', 'card3_title', 'Accueil')) ?></h3>
                    <p class="vf-card-text"><?= htmlspecialchars(vf_text($txt, 'experience', 'card3_text', 'Un accueil attentif et des recommandations locales pour profiter pleinement de votre séjour.')) ?></p>
                </div>
            </article>

...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['add_module'])) {
    ...
    $fichier_php = htmlspecialchars($_POST['fichier_php']); // Nouveau champ
...
<body>
    ...
    <main>
        ...
        <table class="table">
            <thead>
                <tr>
                    ...
                    <th>Nom</th>
                    <th>Description</th>
                    <th>Fichier PHP</th> <!-- Nouveau champ -->
                    <th>Actions</th>
                </tr>
            </thead>
            <tbody>
        ...
        <form action="modules.php" method="post">
            ...
            <label for="fichier_php">Nom du fichier PHP :</label> <!-- Nouveau champ -->
            <input type="text" name="fichier_php" placeholder="ex: module1.php" required>

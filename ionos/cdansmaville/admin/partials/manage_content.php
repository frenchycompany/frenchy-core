...
if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST['upload_images'])) {
    ...
    header("Location: ?section=content&client_id=" . $client_id);
    exit();
}
...
<div>
    <h2>Personnalisation Visuelle pour <?php echo htmlspecialchars($client['nom'], ENT_QUOTES, 'UTF-8'); ?></h2>
    <form action="?section=content&client_id=<?php echo $client_id; ?>" method="post" enctype="multipart/form-data">
        <label for="logo">Logo :</label>
        <input type="file" name="logo" accept="image/*">
        <?php if (!empty($client['logo'])): ?>
            <img src="<?php echo htmlspecialchars($client['logo'], ENT_QUOTES, 'UTF-8'); ?>" alt="Logo" width="150">
        ...
        <?php if (!empty($client['header_image'])): ?>
            <img src="<?php echo htmlspecialchars($client['header_image'], ENT_QUOTES, 'UTF-8'); ?>" alt="Image d'en-tête" width="300">
        ...
        <?php if (!empty($client['promo_image'])): ?>
            <img src="<?php echo htmlspecialchars($client['promo_image'], ENT_QUOTES, 'UTF-8'); ?>" alt="Promo Image" width="300">

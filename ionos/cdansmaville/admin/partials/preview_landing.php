...
if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST['update_colors'])) {
    ...
    header("Location: ?section=preview&client_id=" . $client_id);
    exit();
}
...
<body>
    ...
    <main>
        ...
        <form action="?section=preview&client_id=<?php echo htmlspecialchars($client_id, ENT_QUOTES, 'UTF-8'); ?>" method="post">

                                ...
                                <div class="col-md-6">
                                    <h5 class="mb-1">
                                        <?php if ((int)$auto['actif'] === 1): ?>
                                            <span class="badge text-bg-success mr-2">ACTIF</span>
                                        <?php else: ?>
                                            <span class="badge text-bg-secondary mr-2">INACTIF</span>
                                        <?php endif; ?>

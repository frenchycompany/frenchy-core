                                ...
                                <tr class="<?= !$user['active'] ? 'table-secondary' : '' ?>">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                ...
                                                <?php if ($user['id'] == $current_user_id): ?>
                                                    <span class="badge text-bg-info ml-1">Vous</span>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        <?php if (($user['role'] ?? 'user') === 'admin'): ?>
                                            <span class="badge text-bg-danger"><i class="fas fa-crown"></i> Admin</span>
                                        <?php else: ?>
                                    ...
                                    <td>
                                        <?php if ($user['active']): ?>
                                            <span class="badge text-bg-success"><i class="fas fa-check"></i> Actif</span>
                                        <?php else: ?>
                                            <span class="badge text-bg-danger"><i class="fas fa-times"></i> Inactif</span>
                                        <?php endif; ?>
                                    </td>
                                    <td>

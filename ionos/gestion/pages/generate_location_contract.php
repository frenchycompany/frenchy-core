...
try {
    ...
    $timestamp = time();
    $dir = __DIR__ . '/../generated_location_contracts';
    if (!is_dir($dir)) {
        mkdir($dir, 0755, true);
    }
...
<body>' . $contract_content . '</body>
    ...
    $stmt->execute([
        ...
        ':file_path' => "generated_location_contracts/$file_name"
    ]);
...
<div class="container-fluid mt-4">
    ...
    <div class="card shadow-sm mb-4">
        <div class="card-body d-flex gap-2 flex-wrap">
            <a href="../generated_location_contracts/<?= $file_name ?>" download class="btn btn-primary btn-lg">
    ...
    <div class="card shadow-sm" id="previewCard">
        ...
        <div class="card-body p-0">
            <iframe id="contractPreview" src="../generated_location_contracts/<?= $file_name ?>"

...
<section class="vf-hero">
    ...
    <div class="vf-hero-content">
        <div class="vf-container">
            <p class="vf-hero-kicker"><?= htmlspecialchars(vf_text($txt, 'hero', 'kicker', 'Héritage · Élégance · Confort')) ?></p>
            <h1 class="vf-hero-title">
                <?= vf_text($txt, 'hero', 'title', 'Une parenthèse rare<br>au cœur de Pierrefonds') ?>
            </h1>
            <p class="vf-hero-desc">
                <?= htmlspecialchars(vf_text($txt, 'hero', 'desc', 'Un château restauré avec soin, où le charme de l\'ancien rencontre l\'exigence d\'un séjour d\'exception. Idéal pour se retrouver, célébrer ou simplement respirer.')) ?>
            </p>

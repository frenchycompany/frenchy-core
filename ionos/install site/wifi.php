...
<div class="guide-highlight">
    ...
    <p class="guide-highlight-value"><?= htmlspecialchars(vf_text($txt, $g, 'network_name', 'MonWiFi')) ?></p>
</div>

<div class="guide-highlight">
    <p class="guide-highlight-label">Mot de passe</p>
    <p class="guide-highlight-value guide-highlight-large"><?= htmlspecialchars(vf_text($txt, $g, 'password', 'motdepasse')) ?></p>
</div>
...
<div class="guide-card">
    ...
    <p><?= vf_text($txt, $g, 'step2', 'Recherchez le nom du réseau (ci-dessus) dans la liste des réseaux disponibles.') ?></p>
</div>

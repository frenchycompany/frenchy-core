                    ...
                    <div class="card shadow-sm mb-4 border-left-primary">
                        <div class="card-header">
                            <h5 class="mb-0">
                                ...
                                <span class="badge badge-primary"><?= count($results['clients']) ?></span>
                            </h5>
                        </div>
                    ...
                    <div class="card shadow-sm mb-4 border-left-success">
                        <div class="card-header">
                            <h5 class="mb-0">
                                ...
                                <span class="badge badge-success"><?= count($results['reservations']) ?></span>
                            </h5>
                        </div>
                        <div class="card-body p-0">
                            <div class="table-responsive">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php if (!empty($resa['nom_du_logement'])): ?>
                                                        <span class="badge badge-info"><?= e($resa['nom_du_logement']) ?></span>
                                                    <?php else: ?>
                    ...
                    <div class="card shadow-sm mb-4 border-left-info">
                        <div class="card-header">
                            <h5 class="mb-0">
                                ...
                                <span class="badge badge-info"><?= count($results['sms']) ?></span>
                            </h5>
                        </div>
                        <div class="card-body">
                                ...
                                <div class="d-flex mb-3 p-2 bg-light rounded">
                                    <div class="mr-3">
                                        <?php if ($sms['direction'] === 'in'): ?>
                                            <span class="badge badge-success"><i class="fas fa-arrow-down"></i> Recu</span>
                                        <?php else: ?>
                                            <span class="badge badge-primary"><i class="fas fa-arrow-up"></i> Envoye</span>
                                        <?php endif; ?>
                                    </div>
                    ...
                    <div class="card shadow-sm mb-4 border-left-warning">
                        <div class="card-header">
                            <h5 class="mb-0">
                                ...
                                <span class="badge badge-warning"><?= count($results['logements']) ?></span>
                            </h5>
                        </div>
                        <div class="card-body">
                                ...
                                <div class="card mb-3 <?= empty($logement['actif']) ? 'bg-light' : '' ?>">
                                    <div class="card-body p-3">
                                        ...
                                        <div class="small mb-2">
                                            <span class="badge badge-info"><?= $logement['nb_resa'] ?> reservation(s)</span>
                                        </div>

                    ...
                    <tbody>
                        ...
                        <tr class="<?= $c['is_active'] ? '' : 'table-secondary' ?>">
                            ...
                            <td>
                                ...
                                <?php if ($c['superhost']): ?>
                                <span class="badge badge-warning ml-1">Superhost</span>
                                <?php endif; ?>
                                <br>
                            ...
                            <td>
                                ...
                                <?php endif; ?>
                                <?php if ($c['cohotes'] > 0): ?>
                                <br><span class="badge badge-secondary"><?= $c['cohotes'] ?> co-hote<?= $c['cohotes'] > 1 ? 's' : '' ?></span>
                                <?php endif; ?>
                            </td>
                            <td>
                                <small>
                            ...
                            <td class="text-center">
                                <span class="badge badge-info"><?= $c['nb_prix'] ?></span>
                            </td>
                            <td class="text-center">
                ...
                <table class="table table-sm">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center"><span class="badge badge-warning"><?= $owner['nb_annonces'] ?></span></td>
                            <td>
                                <small>
                                    <?php

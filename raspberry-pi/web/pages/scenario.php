...
include '../includes/db.php';      // doit définir $host, $user, $password, $database
include '../includes/header.php';  // ton header HTML / Bootstrap, etc.
                    ...
                    <table class="table table-hover mb-0">
                        ...
                        <tbody>
                            <?php foreach ($scenarios as $sc): ?>
                                ...
                                <tr>
                                    <td><?= $id ?></td>
                                    <td><span class="badge badge-info"><?= $nom_logement ?></span></td>
                                    <td><?= $nom_scenario ?></td>

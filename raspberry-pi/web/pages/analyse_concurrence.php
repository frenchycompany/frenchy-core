 ...
 * Exploite les donnees collectees sur les concurrents
 */
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <?php if ($c['note_moy']): ?>
                                    <span class="badge badge-success"><?= $c['note_moy'] ?></span>
                                    <?php else: ?>-<?php endif; ?>
                                </td>
                                <td class="text-center">
                                    <?php if ($c['prix_moy']): ?>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <span class="badge badge-warning"><?= $v['superhosts'] ?></span>
                    ...
                    <table class="table table-sm">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center"><span class="badge badge-warning"><?= $o['nb_annonces'] ?></span></td>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <?php if ($t['superhost']): ?><span class="badge badge-warning">SH</span><?php endif; ?>
                                    <br><small class="text-muted"><?= htmlspecialchars($t['ville']) ?></small>
                                </td>
                                <td class="text-center"><span class="badge badge-success"><?= $t['note_moyenne'] ?></span></td>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <?php if ($ecart !== null): ?>
                                <?php if ($ecart > 10): ?>
                                <span class="badge badge-danger">+<?= $ecart ?>%</span>
                                <?php elseif ($ecart < -10): ?>
                                <span class="badge badge-success"><?= $ecart ?>%</span>
                                <?php else: ?>
                                <span class="badge badge-secondary"><?= $ecart > 0 ? '+' : '' ?><?= $ecart ?>%</span>
                                <?php endif; ?>
                            <?php else: ?>-<?php endif; ?>
                        </td>
                        <td>

            ...
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    <form method="POST">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label><i class="fas fa-phone"></i> Telephone <span class="text-danger">*</span></label>
                        ...
                        <div class="form-group">
                            <label><i class="fas fa-sticky-note"></i> Notes et preferences</label>
...
?>
    ...
    <div class="row">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if (!empty($r['nom_du_logement'])): ?>
                                                    <span class="badge badge-info"><?= e($r['nom_du_logement']) ?></span>
                                                <?php else: ?>
                                            ...
                                            <td>
                                                <a href="reservation_details.php?id=<?= $r['id'] ?>" class="btn btn-sm btn-outline-primary">
        ...
        <div class="col-lg-4">
            ...
            <div class="card shadow-sm mb-4">
                ...
                <div class="card-body">
                    <a href="recus.php?filter=<?= urlencode($viewPhoneNorm) ?>" class="btn btn-outline-info btn-block mb-2">
                        <i class="fas fa-inbox"></i> Voir les SMS
                    </a>
                    <a href="campaigns.php?action=create" class="btn btn-outline-warning btn-block mb-2">
                        <i class="fas fa-bullhorn"></i> Nouvelle campagne
                    </a>
                    <button class="btn btn-primary btn-block" id="btnOpenDrawer2">
    ...
    <div id="smsDrawer" class="drawer" aria-hidden="true">
        <div class="drawer-header d-flex align-items-center">
            ...
            <button class="btn btn-sm btn-outline-secondary ml-auto" id="btnCloseDrawer">
        ...
        <div class="drawer-footer">
            <div class="form-group mb-2">
                <label class="small font-weight-bold">Modele</label>
            ...
            <button id="btnSendSms" class="btn btn-primary btn-block">
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold"><?= $statsTotal ?></div>
                        </div>
        ...
        <div class="col-md-4">
            <div class="card shadow-sm border-left-success">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Fiches creees</div>
                            <div class="h5 mb-0 font-weight-bold"><?= $statsFiches ?></div>
                        </div>
        ...
        <div class="col-md-4">
            <div class="card shadow-sm border-left-warning">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">Clients fideles (2+)</div>
                            <div class="h5 mb-0 font-weight-bold"><?= $statsFideles ?></div>
                        </div>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <span class="badge badge-<?= (int)$row['nb_resa'] >= 2 ? 'success' : 'secondary' ?> badge-pill">
                                            <?= $row['nb_resa'] ?>
                                        </span>
                                    </td>
                                    ...
                                    <td>
                                        <?php if ($hasFiche): ?>
                                            <span class="badge badge-info"><i class="fas fa-check"></i> Oui</span>
                                        <?php else: ?>
                                            <span class="text-muted">-</span>
                                        <?php endif; ?>
                                    </td>

        ...
        <div class="card shadow-sm mb-4">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5 class="mb-0">
                    ...
                    <span class="badge badge-secondary"><?= count($recipients) ?></span>
                </h5>
                <?php if ($can_edit): ?>
                    <button class="btn btn-sm btn-primary" type="button" data-toggle="collapse" data-target="#addRecipientsForm">

...
<div class="row mb-4">
    ...
    <div class="col-md-4 text-right d-flex align-items-center justify-content-end">
        <button class="btn btn-primary mr-2" data-toggle="modal" data-target="#smsModal">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3 p-3 border rounded <?= !empty($reservation['start_sent']) ? 'border-success bg-light' : 'border-secondary' ?>">
                        ...
                        <?php if (!empty($reservation['start_sent'])): ?>
                            <span class="badge badge-success mt-2">✓ Envoyé</span>
                        <?php else: ?>
                            <span class="badge badge-secondary mt-2">Non envoyé</span>
                        <?php endif; ?>
                    </div>
                    ...
                    <div class="mb-3 p-3 border rounded <?= !empty($reservation['mid_sent']) ? 'border-success bg-light' : 'border-info' ?>">
                        ...
                        <?php if (!empty($reservation['mid_sent'])): ?>
                            <span class="badge badge-success mt-2">✓ Envoyé</span>
                        <?php else: ?>
                            <span class="badge badge-info mt-2">Prévu (<?= $duree_sejour ?> nuits)</span>
                        <?php endif; ?>
                    </div>
                    <?php endif; ?>
                    ...
                    <!-- Bouton d'action -->
                    <button class="btn btn-primary btn-block" data-toggle="modal" data-target="#smsModal">

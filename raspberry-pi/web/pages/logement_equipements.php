                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <ul class="nav nav-tabs" id="equipTabs">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" data-toggle="tab" href="#tabAcces">
                                    <i class="fas fa-key"></i> Acces
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" data-toggle="tab" href="#tabCuisine">
                                    <i class="fas fa-utensils"></i> Cuisine
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" data-toggle="tab" href="#tabMenager">
                                    <i class="fas fa-broom"></i> Menager
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" data-toggle="tab" href="#tabSalon">
                                    <i class="fas fa-tv"></i> Salon
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" data-toggle="tab" href="#tabChambres">
                                    <i class="fas fa-bed"></i> Chambres
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" data-toggle="tab" href="#tabSDB">
                                    <i class="fas fa-bath"></i> SDB
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" data-toggle="tab" href="#tabExterieur">
                                    <i class="fas fa-tree"></i> Exterieur
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" data-toggle="tab" href="#tabRegles">
                                    <i class="fas fa-clipboard-list"></i> Regles
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" data-toggle="tab" href="#tabVille">
                                    ...
                                    if ($totalRecos > 0): ?>
                                        <span class="badge badge-info"><?= $totalRecos ?></span>
                                    <?php endif; ?>
                                </a>
                            </li>
                        </ul>
